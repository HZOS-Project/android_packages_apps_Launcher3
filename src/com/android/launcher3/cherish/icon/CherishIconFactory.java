 ...
 */
package com.android.launcher3.cherish.icon;
...
public class CherishIconFactory extends BaseIconFactory {

    private final IconPackStore mIconPackStore;

    public CherishIconFactory(Context context, int fillResIconDpi, int iconBitmapSize) {
